...
<body>
    ...
    <div class="breadcrumb pt-2 pb-4">
        ...
        <span class="divider">></span>
        <div class="sectionCourse">Partners</div>
    </div>

    <div class="container">
        <div class="row">
            <div class="col">
                <a class="btnTambahPartners" href="{{ route('getAddPartner') }}" role="button">Tambah Partner +</a>
            </div>

            <table id="table" class="tablePartners table-striped" style="width:100%">
                <thead>
                    <tr>
                        <th class="id" style="width: .5%;">ID</th>
                        <th class="logo" style="width: .5%;">Logo</th>
                        <th class="name" style="width: 1%;">Name</th>
                        <th class="type" style="width: .5%;">Type</th>
                        <th class="url" style="width: 1%;">URL</th>
                        <th class="address" style="width: 1%;">Address</th>
                        <th class="phone" style="width: 1%;">Phone</th>
                        <th class="email" style="width: 1%;">Email</th>
                        <th class="cp" style="width: 1%;">Contact Person</th>
                        <th class="status" style="width: .5%;">Status Highlight</th>
                        <th class="desc" style="width: .5%;">Description</th>
                        <th class="status" style="width: .5%;">Status</th>
                        <th class="cre" style="width: .5%;">Created At</th>
                        <th class="up" style="width: .5%;">Updated At</th>
                        <th class="act" style="width: .5%;">Action</th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="btn-group">
                                <a href="{{ route('getEditPartner', ['id' => $item->id]) }}" class="btnEdit">Edit</a>
                            </div>
                        </td>
        ...
        <script>
            $(document).ready(function() {
                ...
                buttonContainer.insertBefore('.tablePartners_wrapper .dataTables_length');
