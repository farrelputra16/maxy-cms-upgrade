...
@section('title', 'Ubah Jenis Proposal')
            ...
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                ...
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active">Ubah Jenis Proposal</li>
                    </ol>
                </div>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="card-title-desc">
                        Di halaman ini, Anda dapat memperbarui informasi jenis proposal yang ada dengan mengisi atau
                        mengedit data di bawah ini. Setelah selesai, klik "Simpan & Perbarui" untuk menyimpan perubahan.
                    </p>


                    <form action="{{ route('postEditProposalType', ['id' => request()->query('id')]) }}" method="post"
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-10">
                                <textarea id="content" class="form-control" name="description" placeholder="Masukkan Deskripsi Jenis Proposal">{{ old('description', $currentData->description) }}</textarea>
