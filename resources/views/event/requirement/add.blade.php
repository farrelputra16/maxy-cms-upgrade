...
@section('content')
    <div class="container conTitle">
        <h2 class="h2">Add New Requirement</h2>
    ...
    <div class="container">
        <form class="ui form" action="{{ route('postAddEventRequirement') }}" method="post">
            @csrf
            ...
            <div class="field">
                <div class="ui checkbox">
                    <input class="form-check-input" type="checkbox" value="1" name="upload">
            ...
            <div class="divAdd">
                ...
                <button class="btn btn-primary">Tambahkan Requirement</button>
            </div>
        </form>
