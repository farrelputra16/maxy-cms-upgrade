...
@section('content')
    <div class="px-3 pb-3">
        ...
        <hr>
        <form id="templateForm" class="ui form" action="{{ route('certificate-templates.update', $certificateTemplate->id) }}"
            ...
            <div class="two fields">
                <div class="field">
                    ...
                    <textarea id="templateContent" name="template_content"
                              placeholder="Ex: Telah berhasil menyelesaikan program [[class_name]]">{!! $certificateTemplate->template_content !!}</textarea>
...
@section('scripts')
    ...
    <script>
        ...
        $(function () {
            ...
            maState = {{ Js::from($certificateTemplate->marker_state) }};
