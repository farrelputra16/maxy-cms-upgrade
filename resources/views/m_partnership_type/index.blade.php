...
<body>
    <div class="container conTitle">
        <h2 class="h2">Partnership Type</h2>
        ...
        <div class="container">
            <div class="row">
                <div class="col-10">
                    ...
                    <span class="divider">></span>
                    <div class="sectionPartnership">Partnership Type</div>
                </div>
                <div class="col-2">
                    <a class="btnAdd" href="{{ route('getAddPartnershipType', ['access' => 'm_Partnership_type_create']) }}" role="button">Add Partnership Type +</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        <div class="row">
            <div class="card">
                <div class="card-body">
                    <table id="table" class="tablePartnershipType table-striped custom-striped" style="width:100%">
                        <thead>
                            <tr>
                                <th>ID</th>
                                <th>Name</th>
                        ...
                        <tbody>
                            @foreach ($MPartnershipType as $item)
                            <tr>
                                <td>{{ $item->id }}</td>
                                <td>{{ $item->name }}</td>
                                ...
                                <td>
                                    <div class="btn-group">
                                        <a href="{{ route('getEditPartnershipType', ['id' => $item->id, 'access' => 'm_Partnership_type_update']) }}" class="btnEdit">Edit</a>
                                    </div>
                                </td>
                            </tr>
                            @endforeach
...
<script>
    $(document).ready(function() {
        ...
        buttonContainer.insertBefore('.tablePartnershipType_wrapper .dataTables_length');
