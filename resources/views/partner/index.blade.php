...
<body>
    ...
    <div class="breadcrumb pt-2 pb-4">
        <div class="container">
            <div class="row">
                ...
                <div class="col-2">
                    <a class="btnAdd" href="{{ route('getAddPartner') }}" role="button">Add Partner +</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        <div class="row">
            <div class="card">
                <div class="card-body">
                    <table id="table" class="tablePartners table-striped custom-striped nowrap" style="width:100%">
                        <thead>
                            <tr>
                                <th class="id">ID</th>
                                ...
                                <th class="cp">Contact Person</th>
                                <th class="status">Status Highlight</th>
                                <th class="desc">Description</th>
                                <th class="status">Status</th>
                                <th class="cre">Created At</th>
                                <th class="up">Updated At</th>
