    ...
    <div class="container">
        <div class="row">
            ...
            <div class="card" style="margin-right: 1rem; margin-bottom: 5rem;">
                <div class="card-body">
                    <table id="table" class="tableModule table-striped custom-striped" style="width:100%">
                        <thead>
                            <tr>
                                <th>ID</th>
                                <th>Day</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="btn-group">
                                        <a href="{{ route('getEditCourseClassModule', ['id' => $item->id]) }}" class="btnEdit">Edit</a>
                                        <a href="{{ route('getCourseClassChildModule', ['id' => $item->id]) }}" class="btnContent">Content</a>
                                    </div>
                                </td>
                            </tr>
                            @endforeach
                ...
                <script>
                    $(document).ready(function() {
                        ...
                        buttonContainer.insertBefore('#tableModule .dataTables_length');
