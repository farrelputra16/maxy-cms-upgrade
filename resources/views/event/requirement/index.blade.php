        ...
        <div class="container">
            <div class="row">
                <div class="col-9">
                    ...
                    <span class="divider">></span>
                    <div class="secClass">Requirement</div>
                </div>
                <div class="col text-end">
                    <a class="btn btn-outline border border-dark "
                        href="{{ route('getAddEventRequirement', ['event_id' => $event->id]) }}" role="button"><b>Add
                            Requirement
                            +</b></a>
                </div>
            </div>
