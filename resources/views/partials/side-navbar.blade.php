        ...
        <div id="sidebar-menu">
            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        ...
                        @if (env('APP_ENV') == 'local')
                            ...
                            @endif
                        @endif
                        @if (Session::has('access_master') && Session::get('access_master')->contains('access_master_name', 'm_Course_type_manage'))
                            <li><a href="{{ route('getCourseType') }}" key="t-testimonial">Tipe Mata Kuliah</a></li>
                        @endif
                        @if (env('APP_ENV') != 'local')
                            @if (Session::has('access_master') && Session::get('access_master')->contains('access_master_name', 'course_package_manage'))
                                <li><a href="{{ route('getCoursePackage') }}" key="t-blog">Paket Mata Kuliah</a></li>
                            @endif
                        @endif
                        @if (Session::has('access_master') && Session::get('access_master')->contains('access_master_name', 'm_difficulty_type_manage'))
                        ...
                        @endif
                        @if (Session::has('access_master') && Session::get('access_master')->contains('access_master_name', 'm_proposal_type_manage'))
                            <li><a href="{{ route('getProposalType') }}" key="t-blog">Jenis Proposal</a></li>
                        @endif
                        @if (Session::has('access_master') && Session::get('access_master')->contains('access_master_name', 'm_proposal_status_manage'))
                            <li><a href="{{ route('getProposalStatus') }}" key="t-blog">Status Proposal</a></li>
                        @endif
                        @if (Session::has('access_master') && Session::get('access_master')->contains('access_master_name', 'm_event_type_manage'))
                            <li><a href="{{ route('getEventType') }}" key="t-blog">Tipe Event</a></li>
                        @endif
                        @if (Session::has('access_master') && Session::get('access_master')->contains('access_master_name', 'm_partnership_type_manage'))
                        ...
                        @endif
                        @if (Session::has('access_master') && Session::get('access_master')->contains('access_master_name', 'm_academic_period_manage'))
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        @if (Session::has('access_master') && Session::get('access_master')->contains('access_master_name', 'course_class_manage'))
                        ...
                        @if (Session::has('access_master') && Session::get('access_master')->contains('access_master_name', 'course_class_member_grading_manage'))
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        ...
                        @if (Session::has('access_master') && Session::get('access_master')->contains('access_master_name', 'schedule_manage'))
                            <li><a href="{{ route('getGeneralSchedule') }}" key="t-general-schedule">Jadwal Umum</a></li>
                        @endif
                    </ul>
                </li>
                @endif
                ...
                @if (Session::has('access_master') && Session::get('access_master')->contains(function ($access) {
                    return in_array($access->access_master_name, ['users_manage', 'access_group_manage', 'access_master_manage']);
                }))
                    <li>
                        <a href="javascript: void(0);" class="has-arrow waves-effect">
                        ...
                        <ul class="sub-menu" aria-expanded="false">
                            ...
                            @endif
                            @if (Session::has('access_master') && Session::get('access_master')->contains('access_master_name', 'access_group_manage'))
                                <li><a href="{{ route('getAccessGroup') }}" key="t-access-group">Hak Grup Akses (Peran)</a></li>
                            @endif
                            @if (Session::has('access_master') && Session::get('access_master')->contains('access_master_name', 'access_master_manage'))
                ...
                @if (Session::has('access_master') && Session::get('access_master')->contains(function ($access) {
                    ...
                    <li>
                        ...
                        <ul class="sub-menu" aria-expanded="false">
                            @if (Session::has('access_master') && Session::get('access_master')->contains('access_master_name', 'trans_order_manage'))
                                <li><a href="{{ route('getTransOrder') }}" key="t-order">Pesanan</a></li>
                            @endif
                            @if (Session::has('access_master') && Session::get('access_master')->contains('access_master_name', 'trans_voucher_manage'))
                ...
                @if (Session::has('access_master') && Session::get('access_master')->contains(function ($access) {
                    ...
                    <li>
                        ...
                        <ul class="sub-menu" aria-expanded="false">
                            @if (env('APP_ENV') != 'local')
                                @if (Session::has('access_master') && Session::get('access_master')->contains('access_master_name', 'redeem_code_manage'))
                ...
                @if (Session::has('access_master') && Session::get('access_master')->contains(function ($access) {
                    return in_array($access->access_master_name, ['carousel_manage', 'event_manage', 'partnership_manage', 'user_testimonial_manage']);
                }))
                    <li>
                        <a href="javascript: void(0);" class="has-arrow waves-effect">
                        ...
                        <ul class="sub-menu" aria-expanded="false">
                                ...
                                @endif
                                @if (Session::has('access_master') && Session::get('access_master')->contains('access_master_name', 'partnership_manage'))
                                    <li><a href="{{ route('getPartnership') }}" key="t-partnership">Kerja Sama</a></li>
                                @endif
                                @if (Session::has('access_master') && Session::get('access_master')->contains('access_master_name', 'user_testimonial_manage'))
                                    @if (env('APP_ENV') != 'local')
