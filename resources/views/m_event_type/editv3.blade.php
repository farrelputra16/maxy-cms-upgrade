            ...
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                ...
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active">Edit Tipe Event: {{ $currentData->name }}</li>
                    </ol>
                </div>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('postEditEventType', ['id' => $currentData->id]) }}" method="post"
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-10">
                                <textarea id="elm1" name="description" placeholder="Masukkan Deskripsi Tipe Event">{{ old('description', $currentData->description) }}</textarea>
                            </div>
                        </div>
