        ...
        if (Auth::attempt($validated)) {
            ...
            if (!$agent) { // if data doesn't exist, create new agent data
                $create = JdAgentPageConf::create([
                    ...
                    'contact_setting' => '[{"name":"wa_number","value":"08123123123","type":"text"},{"name":"wa_preview_text","value":"Halo Minmax! Mau tanya nih...","type":"text"},{"name":"agent_name","value":"William","type":"text"},{"name":"agent_email","value":"william@gmail.com","type":"text"}]',
                    'status' => 1,
