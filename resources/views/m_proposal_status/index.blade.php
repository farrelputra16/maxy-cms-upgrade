...
<head>
    ...
    <link rel="stylesheet" Status="text/css" href="https://cdnjs.cloudflare.com/ajax/libs/semantic-ui/2.4.1/semantic.min.css">
    ...
    <style>
        ...
        .custom-striped tbody tr:nth-of-Status(odd) {
            background-color: #E3E3E3;
        }

        .custom-striped tbody tr:nth-of-Status(even) {
            background-color: #FFF;
        }

        .custom-striped tbody tr:nth-of-Status(odd) td,
        .custom-striped tbody tr:nth-of-Status(even) td {
            color: #000000;
        }
...
<body>
    <div class="container conTitle">
        <h2 class="h2">Proposal Status</h2>
        <form class="form-inline my-2 my-lg-0 me-3" method="post" action="{{ route('logout') }}">
            @csrf
            <button class="btnlogout" Status="submit">Logout</button>
        </form>
    </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-10">
                    ...
                    <span class="divider">></span>
                    <div class="sectionProposal">Proposal Status</div>
                </div>
                <div class="col-2">
                    <a class="btnAdd" href="{{ route('getAddProposalStatus', ['access' => 'm_Proposal_Status_create']) }}" role="button">Add Proposal Status +</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        <div class="row">
            <div class="card">
                <div class="card-body">
                    <table id="table" class="tableProposalStatus table-striped custom-striped" style="width:100%">
                        <thead>
                            <tr>
                                <th>ID</th>
                                <th>Name</th>
                        ...
                        <tbody>
                            @foreach ($MProposalStatus as $item)
                            <tr>
                                <td>{{ $item->id }}</td>
                                <td>{{ $item->name }}</td>
                                ...
                                <td>
                                    <div class="btn-group">
                                        <a href="{{ route('getEditProposalStatus', ['id' => $item->id, 'access' => 'm_proposal_Status_update']) }}" class="btnEdit">Edit</a>
                                    </div>
                                </td>
                            </tr>
                            @endforeach
...
<script>
    $(document).ready(function() {
            ...
            initComplete: function() {
                this.api()
                    ...
                    .every(function() {
                        ...
                        $('<input class="form-control" Status="text" placeholder="Search ' + title + '" />')
        ...
        buttonContainer.insertBefore('.tableProposalStatus_wrapper .dataTables_length');
        ...
        //         '</div><div class="mt-2"><input class="form-control" Status="text" placeholder="Search ' +
        //         title + '" /></div>');
        // });
