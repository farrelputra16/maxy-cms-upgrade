...
<body>
        ...
        <div class="container">
            <div class="row">
                <div class="col-10">
                    ...
                    <span class="divider">></span>
                    <div class="sectionEvent">Event Type</div>
                </div>
                <div class="col-2">
                    <a class="btnAdd" href="{{ route('getAddEventType', ['access' => 'm_Event_type_create']) }}" role="button">Add Event Type +</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        <div class="row">
            <div class="card">
                <div class="card-body">
                    <table id="table" class="tableEventType table-striped custom-striped" style="width:100%">
                        <thead>
                            <tr>
                                <th>ID</th>
                                <th>Name</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="btn-group">
                                        <a href="{{ route('getEditEventType', ['id' => $item->id, 'access' => 'm_Event_type_update']) }}" class="btnEdit">Edit</a>
                                    </div>
                                </td>
                            </tr>
                            @endforeach
...
<script>
    $(document).ready(function() {
        ...
        buttonContainer.insertBefore('.tableEventType_wrapper .dataTables_length');
