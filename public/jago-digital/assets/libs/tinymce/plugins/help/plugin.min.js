...
!(function () {
    ...
    const A = (e, t) =>
            b.load(
                `tinymce.html-i18n.help-keynav.${t}`,
                `${e}/js/i18n/keynav/${t}.js`
            ),
        C = (e) => A(e, f.getCode()).catch(() => A(e, "en"));
    var w = tinymce.util.Tools.resolve("tinymce.Env");
    const S = (e) => {
            const t = w.os.isMacOS() || w.os.isiOS(),
                n = t
                    ? {
                          alt: "&#x2325;",
                          ctrl: "&#x2303;",
            ...
            items: [
                {
                    ...
                    cells: y(M, (e) => {
                        const t = y(e.shortcuts, S).join(" or ");
                        return [e.action, t];
                    }),
                },
            ],
        ...
        _ = (e) => {
            const t = (e) =>
                    ...
                    ((e, t, n) => {
                        ...
                        () =>
                            ((e, n) => {
                                ...
                                return { name: n, html: n };
                            })(e, n),
                        (e) => {
                            const n =
                                "premium" === e.type ? `${e.name}*` : e.name;
                            return {
                                name: n,
                                html: t({
                                    name: n,
                ...
                r = {
                    ...
                    presets: "document",
                    html: [
                        ((e) => (null == e ? "" : "<div>" + a(e) + "</div>"))(
                            e
                        ),
                        (() => {
                            const e = h(x, ({ type: e }) => "premium" === e),
                                t = d(
                                    y(e, (e) => e.name),
                            ...
                            return (
                                ...
                                "</b></p><ul>" +
                                n +
                                '<li class="tox-help__more-link" "><a href="https://www.tiny.cloud/pricing/?utm_campaign=editor_referral&utm_medium=help_dialog&utm_source=tinymce" rel="noopener" target="_blank" data-alloy-tabstop="true" tabindex="-1">' +
        ...
        (async (e, t, a) => {
            const o = T(),
                ...
                c = (() => {
                    var e, t;
                    const n =
                        '<a data-alloy-tabstop="true" tabindex="-1" href="https://www.tiny.cloud/docs/tinymce/6/changelog/?utm_campaign=editor_referral&utm_medium=help_dialog&utm_source=tinymce" rel="noopener" target="_blank">TinyMCE ' +
                        ((e = O.majorVersion),
                        (t = O.minorVersion),
                        (0 === e.indexOf("@") ? "X.X.X" : e + "." + t) +
                            "</a>");
                    return {
                        name: "versions",
                        title: "Version",
            ...
            return m.from(r(e)).fold(
                () =>
                    ((e) => {
                        const t = g(e),
                            n = t.indexOf("versions");
                        return (
                            -1 !== n && (t.splice(n, 1), t.push("versions")),
                            { tabs: e, names: t }
                        );
                    })(u),
                (e) =>
            ...
            const a = {
                ...
                tabs: ((e) => {
                    ...
                    y(n, (e) => {
                        return v((n = t), (a = e)) ? m.from(n[a]) : m.none();
                        var n, a;
                    })
                ),
            };
