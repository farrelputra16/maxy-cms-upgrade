...
@section('title', 'Ubah Jenis Modul')
    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0 font-size-18">Ubah Data Jenis Modul</h4>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('postEditModuleType', ['id' => $currentData->id]) }}" method="post"
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-10">
                                <div class="input-group">
                                    <input type="text" id="iconPicker" class="form-control" placeholder="Pilih Ikon"
                                        name="icon" value="{{ old('icon', $currentData->icon) }}">
