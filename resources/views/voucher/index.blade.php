...
<head>
    ...
    <title>Voucher</title><!-- Include CSS libraries for styling the table -->
...
<body>
    ...
    <div class="breadcrumb pt-2 pb-4">
        <div class="container">
            <div class="row">
                ...
                <div class="col-2">
                    <a class="btnAdd" href="{{ route('getAddVoucher') }}" role="button">Add Voucher</a>
                </div>
            </div>
        </div>
    ...
    <div class="container">
        <div class="row">
            <div class="card">
                <div class="card-body">
                    <table id="table" class="tableVoucher table-striped custom-striped nowrap" style="width:100%">
                        <thead>
                            <tr>
                                <th>ID</th>
                                <th>Voucher Name</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="btn-group">
                                        <a href="{{ route('getEditVoucher', ['id' => $item->id]) }}" class="btnEdit">Edit</a>
                                    </div>
                                </td>
                            </tr>
                            @endforeach
...
<script>
    $(document).ready(function() {
        ...
        buttonContainer.insertBefore('.tableVoucher_wrapper .dataTables_length');
