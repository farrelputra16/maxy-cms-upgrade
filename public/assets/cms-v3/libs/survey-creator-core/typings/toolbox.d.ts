...
export declare class QuestionToolboxItem extends Action implements IQuestionToolboxItem {
    ...
    getSubitemByName(id: string): QuestionToolboxItem;
     ...
     * @see clearSubitems
     */
    addSubitem(item: IQuestionToolboxItem, index?: number): void;
    /**
     ...
     * @see addSubitem
     */
    removeSubitem(item: IQuestionToolboxItem | string): void;
}
/**
...
export declare class QuestionToolbox extends AdaptiveActionContainer<QuestionToolboxItem> implements IQuestionToolbox {
    ...
    lockScrollBar(val: boolean): void;
