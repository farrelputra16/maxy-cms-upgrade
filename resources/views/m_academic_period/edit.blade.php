...
<head>
    ...
    <title>Edit Academic Period</title>
...
<body>
    <div class="container conTitle">
        <h2 class="h2">Edit Academic Period</h2>
    ...
    <div class="breadcrumb pt-2 pb-4">
        ...
        <span class="divider">></span>
        <div class="sectionEvent">Event</div>
    </div>

    <div class="container">
        <form class="ui form" action="{{ route('postEditAcademicPeriod', ['id' => request()->query('id')]) }}" method="post" enctype="multipart/form-data">
            @csrf
            <div class="field">
                <div class="field">
                ...
                <div class="field">
                    ...
                    <input type="date" id="date_start" name="date_start" value="{{ $currentData->date_start }}">
                ...
                <div class="field">
                    ...
                    <input type="date" id="date_end" name="date_end" value="{{ $currentData->date_end }}">
