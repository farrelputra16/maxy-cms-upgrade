...
<body>
    ...
    <div class="ui breadcrumb pt-2 pb-4">
            ...
            <div class="active section">Course Type</div>
        </div>
    <div id="example_wrapper">
        <div class="navbar bg-body-tertiary" style="padding: 12px 0px 12px 0px;">
            <div class="navbar-nav">
                <a class="btn btn-primary" href="{{ route('getAddCourseType', ['access' => 'm_course_type_create']) }}" role="button">Tambah Course Type +</a>
            </div>
        </div>
            ...
            <tbody>
                    @foreach ($mCourseType as $item)
                        <tr>
                            ...
                            <td>
                                <div class="btn-group">
                                    <a href="{{ route('getEditCourseType', ['id' => $item->id, 'access' => 'm_course_type_update']) }}" class="btn btn-primary">Edit</a>
                                    <a href="{{ route('getCourseClassChildModule', ['id' => $item->id]) }}"
                                        class="btn btn-info">Sertifikat Template</a>
                                </div>
                            </td>
                        </tr>
                    @endforeach
