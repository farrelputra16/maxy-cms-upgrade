...
return [
    ...
    'settings'      => [
        'default' => [
            ...
            'HTML.AllowedElements' => 'div, span, script',
            'HTML.AllowedAttributes' => 'id, class, style, src, async, type, data-*',
