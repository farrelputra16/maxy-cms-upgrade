tinymce.Resource.add(
    ...
    "<h1>Begin keyboard navigation</h1>\n" +
        ...
        "  <li>move between items in the footerâ€™s element path.</li>\n" +
        "</ul>\n" +
        "\n" +
        ...
        "\n" +
        "<p>If the current focus is at the â€˜topâ€™ of a particular UI section, pressing the <strong>Esc</strong> key also exits\n" +
