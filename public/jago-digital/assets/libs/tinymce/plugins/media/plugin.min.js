    ...
    const ae = (e) => {
        ...
        ie = (e, t, r) => {
            const o = "img" === t.name || "video" === e.name,
                ...
                i = o ? s : null;
            t.attr({
                width: se(e, r, "width", a),
                height: se(e, r, "height", i),
            });
        },
        ne = (e, t) => {
            const r = t.name,
        ...
        de = (e, t, r) => {
            const o = (0, e.options.get)("xss_sanitization"),
                a = f(e);
            return M(e.schema, { sanitize: o, validate: a }).parse(r, {
                context: t,
            });
        },
        he = (e) => (t) => {
            ...
            ((e) => {
                e.on("PreInit", () => {
                    const { schema: t, serializer: r, parser: o } = e,
                        a = t.getBoolAttrs();
                    l(
                        "webkitallowfullscreen mozallowfullscreen".split(" "),
                        (e) => {
                            a[e] = {};
                        }
                    ),
