...
<body>
    ...
    <div class="breadcrumb pt-2 pb-4">
        <div class="container">
            <div class="row">
                ...
                <div class="col-2">
                    <a class="btnAdd" href="{{ route('getAddGeneral') }}" role="button">Add Data</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        <div class="row">
            <div class="card">
                <div class="card-body">
                    <table id="table" class="tableSettings table-striped custom-striped nowrap" style="width:100%">
                        <thead>
                            <tr>
                                <th>ID</th>
                                <th>Name</th>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div style="display: flex; gap: 10px; align-items: flex-start;">
                                        <a href="{{ route('getEditGeneral', ['id' => $item->id]) }}" class="btnEdit btn-primary" style="width: 50px;">Edit</a>
...
<script>
    $(document).ready(function() {
        ...
        buttonContainer.insertBefore('.tableSettings_wrapper .dataTables_length');
