            ...
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                ...
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active">Tambah Jenis Kelas</li>
                    </ol>
                </div>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <h4 class="card-title">Tambah Jenis Kelas</h4>
                    ...
                    <form id="addClassType" action="{{ route('postAddClassType') }}" method="post"
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-10">
                                ...
                                placeholder="Contoh: Pagi, Siang atau Malam" value="{{ old('name') }}">
                                @if ($errors->has('name'))
                        ...
                        <div class="mb-3 row justify-content-end">
                            <div class="text-end">
                                <button type="submit" class="btn btn-primary w-md text-center custom-btn-submit"
                                    form="addClassType">Tambah Jenis Kelas</button>
                            </div>
                        </div>
                    </form>
                </div>
