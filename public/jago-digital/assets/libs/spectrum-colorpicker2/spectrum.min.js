!(function (e) {
            ...
            if (s) {
                ...
                r.push(
                    '<span title="' +
                        ...
                        '" class="' +
                        l +
                        '" role="button" tabindex="0"><span class="sp-thumb-inner" style="' +
                        u +
                        ';"></span></span>'
                );
            } else
                r.push(
                    '<span class="sp-thumb-el sp-clear-display" role="button" tabindex="0"><span class="sp-clear-palette-only" style="background-color: transparent;"></span></span>'
                );
        }
    ...
    function n(e, t) {
        var a,
            ...
            h = (function (e, t) {
                (e.locale = e.locale || window.navigator.language),
                    ...
                    "en" != e.locale &&
                        Ne.spectrum.localization[e.locale] &&
                        (e = Ne.extend(
                            {},
                            Ne.spectrum.localization[e.locale],
                            e
        ...
        function we() {
            (m <= 0 || b <= 0 || x <= 0) && Oe(),
                ...
                E.addClass(R),
                (H = null),
                O.trigger("dragstart.spectrum", [Ae()]);
        }
        function _e() {
            ...
            p
                ...
                : (O.trigger(e, [Ae()]),
                  !1 === u.beforeShow(Ae()) ||
                      ...
                      (p = !0),
                      Ne(L).on("keydown.spectrum", Ce),
                      Ne(L).on("click.spectrum", Se),
                      Ne(window).on("resize.spectrum", f),
                      ae.attr("aria-expanded", !0),
        ...
        function Me() {
            p &&
                !d &&
                ((p = !1),
                Ne(L).off("keydown.spectrum", Ce),
                Ne(L).off("click.spectrum", Se),
                Ne(window).off("resize.spectrum", f),
                ae.attr("aria-expanded", !1),
                ae.removeClass("sp-active"),
                E.addClass("sp-hidden"),
                u.hide(Ae()),
                O.trigger("hide.spectrum", [Ae()]));
        }
        function ze() {
            je(se, !0), Le(!0);
        }
                ...
                d ||
                    ...
                    h.offset
                        ...
                        : E.offset(
                              ...
                              (n = e[0].ownerDocument),
                              (s = n.documentElement),
                              (i = s.clientWidth + Ne(n).scrollLeft()),
                              (l = s.clientHeight + Ne(n).scrollTop()),
                              (c = t.offset()),
                              (u = c.left),
                              (f = c.top),
                              (f += r),
        ...
        !(function () {
            if (
                (Ve && E.find("*:not(input)").attr("unselectable", "on"),
                me(),
                (fe = Ne('<span class="sp-original-input-container"></span>')),
            ...
            function a(e) {
                return (
                    e.data && e.data.ignore
                        ? (je(
                              Ne(e.target).closest(".sp-thumb-el").data("color")
                          ),
                          Re())
                        : (je(
                              Ne(e.target).closest(".sp-thumb-el").data("color")
                          ...
                          Re(),
                          h.hideAfterPaletteSelect ? (Le(!0), Me()) : Le()),
                    !1
                );
            }
            ve(),
                oe.on("click.spectrum touchstart.spectrum", function (e) {
                    Q || Pe(),
                        e.stopPropagation(),
                        Ne(e.target).is("input") || e.preventDefault();
                }),
                (!O.is(":disabled") && !0 !== h.disabled) || Qe(),
                E.on("click", Xe),
                E.on("keydown", 'div[role="button"]', function (e) {
                ...
                J.on("click.spectrum", function (e) {
                    e.stopPropagation(),
                        e.preventDefault(),
                        Ve && $.is(":focus") && $.trigger("change"),
                        $.hasClass("sp-validation-error") || (Le(!0), Me());
                }),
                Z.text(
                    h.showPaletteOnly
                        ? h.togglePaletteMoreText
    ...
    function Ge(s, i, t, e) {
        ...
        function g() {
            c &&
                (Ne(l).off(a),
                Ne(l.body).removeClass("sp-dragging"),
                setTimeout(function () {
                    e.apply(s, arguments);
                }, 0)),
                (c = !1);
        ...
        (a.selectstart = p),
            ...
            Ne(s).on("touchstart mousedown", function (e) {
                (e.which ? 3 == e.which : 2 == e.button) ||
                    ...
                    (!1 !== t.apply(s, arguments) &&
                        ...
                        (u = Ne(s).offset()),
                        Ne(l).on(a),
                        Ne(l.body).addClass("sp-dragging"),
                        o(e),
                        p(e)));
            });
    }
    ...
    (Ne.fn.spectrum = function (a, e) {
            ...
            this.each(function () {
                ...
                if (e) {
                    ...
                    "get" == a
                        ...
                        : "destroy" == a
                        ? (e.destroy(), Ne(this).removeData(s))
                        : t.apply(e, r);
                }
            }),
            o
        ...
        (Ne.fn.spectrum.load = !0),
        (Ne.fn.spectrum.loadOpts = {}),
        (Ne.fn.spectrum.draggable = Ge),
        (Ne.fn.spectrum.defaults = qe),
        (Ne.fn.spectrum.inputTypeColorSupport = function e() {
        ...
        (Ne.spectrum = {}),
        (Ne.spectrum.localization = {}),
        (Ne.spectrum.palettes = {}),
        (Ne.fn.spectrum.processNativeColorInputs = function () {
    ...
    (jQuery.spectrum.localization.gr = {
        cancelText: "Î‘ÎºÏÏÏ‰ÏƒÎ·",
        chooseText: "Î•Ï€Î¹Î»Î¿Î³Î®",
        clearText: "ÎšÎ±Î¸Î±ÏÎ¹ÏƒÎ¼ÏŒÏ‚ ÎµÏ€Î¹Î»ÎµÎ³Î¼Î­Î½Î¿Ï… Ï‡ÏÏŽÎ¼Î±Ï„Î¿Ï‚",
        noColorSelectedText:
            "Î”ÎµÎ½ Î­Ï‡ÎµÎ¹ ÎµÏ€Î¹Î»ÎµÏ‡Î¸ÎµÎ¯ ÎºÎ¬Ï€Î¿Î¹Î¿ Ï‡ÏÏŽÎ¼Î±",
        togglePaletteMoreText: "Î ÎµÏÎ¹ÏƒÏƒÏŒÏ„ÎµÏÎ±",
        togglePaletteLessText: "Î›Î¹Î³ÏŒÏ„ÎµÏÎ±",
    }),
    ...
    (jQuery.spectrum.localization.ko = {
        ...
        noColorSelectedText: "ì„ íƒëœ ìƒ‰ìƒ ì—†ìŒ",
