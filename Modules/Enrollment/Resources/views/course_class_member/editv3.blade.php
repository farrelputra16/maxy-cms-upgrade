...
@section('title', 'Ubah Anggota Kelas')
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <h4 class="card-title">Ubah Anggota Kelas: {{ $courseClassMember->id }} -
                    ...
                    <form action="{{ route('postEditCourseClassMember', $courseClassMember->id) }}" method="post"
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-10">
                                <textarea id="content" class="form-control" name="content">{{ old('content', $courseClassMember->description) }}</textarea>
                            </div>
                        </div>
