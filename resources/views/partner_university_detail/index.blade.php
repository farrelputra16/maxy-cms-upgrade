...
<body>
    <div class="container conTitle">
        <h2 class="h2">Partner University Detail</h2>
    ...
    <div class="breadcrumb pt-2 pb-4">
        ...
        <span class="divider">></span>
        <div class="sectionPartners">Partners</div>
    </div>

    <div class="container">
        <div class="row">
            <div class="col">
                <a class="btnPartners" href="{{ route('getAddPartnerUniversityDetail') }}" role="button">Tambah Detail Partner Universitas +</a>
            </div>
