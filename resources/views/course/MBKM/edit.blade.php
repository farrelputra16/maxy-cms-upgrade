...
<body>
    ...
    <div class="breadcrumb pt-2 pb-4">
        ...
        <span class="divider">></span>
        <div class="sectionCourse">MBKM</div>
    </div>
        ...
        <form class="ui form" action="{{ route('postEditCourse', ['id' => request()->query('id')]) }}" method="post" enctype="multipart/form-data">
            ...
            <div class="field">
                ...
                <div class="two fields">
                    ...
                    <div class="field d-none" id="mini_fake_price">
                    ...
                    <div class="field d-none" id="mini_price">
