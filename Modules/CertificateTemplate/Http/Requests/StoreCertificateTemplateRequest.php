...
class StoreCertificateTemplateRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'filename' => 'required|file|mimes:png|max:10240',
    ...
    public function messages()
    {
        return [
            ...
            'filename.required' => 'File template sertifikat tidak boleh kosong',
            'filename.file' => 'File template sertifikat harus berupa file',
            ...
            'template_content.required' => 'Konten template tidak boleh kosong',
