        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('postAddRedeemCode') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="mb-3 row">
                        ...
                        <div class="mb-3 row justify-content-end">
                            <div class="text-end">
                                <button type="submit" class="btn btn-primary w-md text-center">Add Redeem Code</button>
                            </div>
                        </div>
                    </form>
                </div>
