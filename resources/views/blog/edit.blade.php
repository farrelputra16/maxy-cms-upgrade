        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <h4 class="card-title">{{ $blog->name }} <small>[ ID: {{ $blog->id }} ]</small></h4>
                    ...
                    <form action="{{ route('postEditBlog', ['id' => request()->query('id')]) }}" method="post"
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-10" style="height: 200px">
                                ...
                                <img id="frame"
                                    src="{{ asset('uploads/blog/' . $blog->slug . '/' . $blog->cover_img) }}"
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-10">
                                <input class="form-control" type="text" name="description"
                                    value="{{ $blog->description }}" id="input-description">
                            </div>
                        </div>
                        <div class="row form-switch form-switch-md mb-3 p-0" dir="ltr">
                            ...
                            <div class="col-md-10" style="display: flex; align-items: center;">
                                <input class="form-check-input p-0 m-0" type="checkbox" id="SwitchCheckSizemd"
                                    value="1" {{ $blog->status == 1 ? 'checked' : '' }} name="status"
                                    style="left: 0;">
                            </div>
                        </div>
