...
<head>
    ...
    <title>Edit Proposal Status</title>
...
<body>
    <div class="container conTitle">
        <h2 class="h2">Edit Proposal Status</h2>
    ...
    <div class="container">
        <form class="ui form" action="{{ route('postEditProposalStatus', ['id' => request()->query('id')]) }}" method="post" enctype="multipart/form-data">
            @csrf
            <div class="field">
                <div class="field">
