            ...
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                ...
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active">Ubah Program Studi</li>
                    </ol>
                </div>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <h4 class="card-title">Ubah: {{ $Category->name }}</h4>
                    ...
                    <form action="{{ route('postEditCategory', ['id' => $Category->id]) }}" method="post"
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-10">
                                <textarea id="content" class="form-control" name="description" placeholder="Masukkan Deskripsi Kategori">{{ old('description', $Category->description) }}</textarea>
