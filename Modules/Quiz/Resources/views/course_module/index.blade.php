        ...
        <div id="example_wrapper">
            <div class="navbar bg-body-tertiary" style="padding: 12px 0px 12px 0px;">
                <div class="navbar-nav">
                    <a
                        href="{{ route('getAddCMQuiz', ['id' => $module_detail->id, 'course_id' => $module_detail->course_id]) }}"><button
            ...
            <table id="example" class="table table-striped" style="width:100%">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="btn-group">
                                <a href="{{ route('getEditCMQuiz', ['id' => $item->id, 'parent_id' => $module_detail->id]) }}" class="btn btn-primary">Edit</a>
                            </div>
                        </td>
                    </tr>
                    @endforeach
                ...
                <tfoot>
                    <tr>
                        ...
                        <th><input type="text" class="form-control search-1" placeholder="Search Account Name" /></th>
                        <th><input type="text" class="form-control search-2" placeholder="Search Account Number" /></th>
                        <th><input type="text" class="form-control search-3" placeholder="Search Bank Name" /></th>
                        ...
                        <th><input type="text" class="form-control search-7" placeholder="Search Status" /></th>
                        ...
                        <th><input type="text" class="form-control search-11" placeholder="Search Status" /></th>
                        <th><input type="text" class="form-control search-12" placeholder="Search Status" /></th>
                        <th><input type="text" class="form-control search-13" placeholder="Search Status" /></th>
                        <th><input type="text" class="form-control search-14" placeholder="Search Status" /></th>
                        <th></th>
                    </tr>
                </tfoot>
            </table>
        ...
        <script>
            $(document).ready(function () {
                var table = $('#example').DataTable({
                    ...
                    order: [[1, "asc"]],
                    columnDefs: [
                        { "visible": false, "targets": [0, 3, 10, 11, 12, 13] }
                    ],
                    columns: [
                        null,
                        null,
