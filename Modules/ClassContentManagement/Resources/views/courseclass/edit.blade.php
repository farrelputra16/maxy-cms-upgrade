...
@section('content')
    <div style="padding: 0px 12px 0px 12px;">
        <h2 style="padding-bottom:3%">Edit Class</h2>
            ...
            <div class="field">
                ...
                <div class="field">
                    ...
                    <select name="courseid" class="ui dropdown">
                        <option selected value="{{ $currentData->course_id }}">{{ $currentData->course_name }}</option>
        ...
        <a href="{{ route('getAddCourseClassModule', ['id' => $courseclasses->id]) }}"><button class=" right floated ui button primary">Tambah Course Module</button></a>
