...
@section('content')
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <table id="datatable" class="table table-bordered dt-responsive nowrap w-100">
                        ...
                        <tbody>
                            @foreach ($MPartnerType as $key => $item)
                                <tr>
                                    <td>{{ $key + 1 }}</td>
                                    <td>{{ $item->id }}</td>
                                    ...
                                    <td>
                                        <a href="{{ route('getEditPartnerType', ['id' => $item->id, 'access' => 'm_Partner_type_update']) }}"
    ...
    <div id="floating-whatsapp-button">
        <a href="{{ route('getAddPartnerType', ['access' => 'm_Partner_type_create']) }}" target="_blank"
