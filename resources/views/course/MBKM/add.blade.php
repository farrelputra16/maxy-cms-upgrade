...
<body>
    ...
    <div class="container">
        <form class="formAdd ui form" action="{{ route('postAddCourse') }}" method="post" enctype="multipart/form-data">
            ...
            <div class="field">
                <div class="two fields">
                    <div class="field">
                        ...
                        <input type="text" name="name" placeholder="Masukkan Nama MBKM">
                        @if ($errors->has('name'))
                ...
                <div class="two fields">
                    <div class="field">
                        <label for="">MBKM Type</label>
                        <select name="type" class="ui dropdown" id="type_selector">
                            <option selected value="">-- Pilih Tipe MBKM --</option>
            ...
            <div class="divAdd">
                <button class="btnAdd">Add MBKM</button>
            </div>
        </form>
