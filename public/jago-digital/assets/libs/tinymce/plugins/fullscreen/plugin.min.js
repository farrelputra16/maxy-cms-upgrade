...
!(function () {
    ...
    const Ce = (e, t) => ({
        ...
        Re = (e) => {
            ...
            return ke().browser.isFirefox()
                ? w.none()
                : w.from(t.visualViewport);
        },
        Le = (e, t, n, r) => ({
            x: e,
            y: t,
    ...
    const He = (e) => {
        ...
        $e = (e) => {
            const t = ((e, t) => {
                ...
                return "" !== r || z(e)
                    ? r
                    : ((e, t) => (C(e) ? e.style.getPropertyValue(t) : ""))(
                          n,
                          t
                      );
            })(e, "background-color");
            ...
            const n = document.body,
                ...
                y = () => {
                    h &&
                        ...
                        w
                            .from(t.get())
                            .each((e) => e.fullscreenChangeHandler.unbind());
                };
            if (u)
