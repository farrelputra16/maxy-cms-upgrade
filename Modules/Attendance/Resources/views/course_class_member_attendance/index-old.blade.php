...
@section('styles')
    <style>
        ...
        .tableClass .batch {
            ...
            /* Menambahkan titik-titik jika teks melebihi lebar maksimum */
            white-space: nowrap;
            /* Memastikan teks tidak wrap ke baris baru */
        }
...
@section('content')
    ...
    <div class="container conTitle">
        <h2>
            Attendance {{ $class->course_name }} Batch {{ $class->batch }}
        </h2>
        ...
        <div class="container">
            <div class="row">
                <div class="col-9">
                    ...
                    <span class="divider">></span>
                    <div class="secClass">Member Attendance</div>
                </div>
            </div>
        </div>
    </div>
                            ...
                            @foreach ($attendance as $key => $item)
                                <tr>
                                    ...
                                    <td class="data-long" data-toggle="tooltip" data-placement="top"
                                        ...
                                        {!! !empty($item->attendance->description) ? \Str::limit($item->attendance->description, 30) : '-' !!}
                                    </td>
                                    <td>{{ $item->attendance ? $item->attendance->created_at : '-' }}</td>
                                    <td>{{ $item->attendance ? $item->attendance->created_id : '-' }}</td>
                                    <td>{{ $item->attendance ? $item->attendance->updated_at : '-' }}</td>
                                    <td>{{ $item->attendance ? $item->attendance->updated_id : '-' }}</td>
