...
<head>
    ...
    <style>
        ...
        .content td:ntn-child(6) {
            max-width: 200px;
            word-wrap: break-word;
        }

        .tableTesti td:nth-child(6) div {
        ...
        .tableTesti th.content,
        .tableTesti td.content {
            max-width: 200px;
            white-space: nowrap;
            overflow: hidden;
...
<body>
    <div class="container conTitle">
        <h2 class="h2">Member Testimonials</h2>
    ...
    <div class="container">
        <div class="row">
            <div class="card">
                <div class="card-body">
                    <table id="table" class="tableTesti table-striped custom-striped nowrap" style="width:100%">
                        <thead>
                            <tr>
                                <th>ID</th>
                                <th>Stars</th>
