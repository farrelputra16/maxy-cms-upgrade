...
@section('title', 'Ubah Tipe Kemitraan')
            ...
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                ...
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active">Ubah Tipe Kemitraan: {{ $currentData->name }}</li>
                    </ol>
                </div>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('postEditPartnershipType', ['id' => $currentData->id]) }}" method="post"
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-10">
                                <textarea id="content" class="form-control" name="description" placeholder="Masukkan Deskripsi Tipe Kemitraan">{{ old('description', $currentData->description) }}</textarea>
                            </div>
                        </div>
