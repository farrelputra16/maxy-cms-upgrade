        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('postAddDifficultyType') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-10">
                                <input class="form-control" type="text" name="name"" id="name" placeholder="Masukkan Nama Difficulty">
                                @if ($errors->has('name'))
                        ...
                        <div class="mb-3 row justify-content-end">
                            <div class="text-end">
                                <button type="submit" class="btn btn-primary w-md text-center" style="margin-right: 1%">Add Difficulty</button>
                            </div>
                        </div>
                    </form>
