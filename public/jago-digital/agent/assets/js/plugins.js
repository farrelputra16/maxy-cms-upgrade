...
jQuery(document).ready(function (s) {
    ...
    function u(i) {
        ...
        if (i.parents(".dtr-animated-headline").hasClass("type")) {
            ...
            !(function i(e, a, n, d) {
                ...
                m(e.find("i").eq(0), e, p, r);
        } else
            i.parents(".dtr-animated-headline").hasClass("clip")
                ? i
                      .parents(".dtr-words-wrapper")
                      .animate({ width: "2px" }, c, function () {
                          w(i, e), f(e);
                      })
                : i.parents(".dtr-animated-headline").hasClass("loading-bar")
                ? (i.parents(".dtr-words-wrapper").removeClass("is-loading"),
                  w(i, e),
                  setTimeout(function () {
                      u(e);
                  }, n),
    ...
    function f(s, i) {
        s.parents(".dtr-animated-headline").hasClass("type")
            ? (m(s.find("i").eq(0), s, !1, i),
              s.addClass("is-visible").removeClass("is-hidden"))
            : s.parents(".dtr-animated-headline").hasClass("clip") &&
              s
                  .parents(".dtr-words-wrapper")
                  .animate({ width: s.width() + 10 }, c, function () {
                      setTimeout(function () {
                          u(s);
                      }, p);
                  });
    ...
    function m(s, i, e, a) {
        s.addClass("in").removeClass("out"),
            s.is(":last-child")
                ? (i.parents(".dtr-animated-headline").hasClass("type") &&
                      setTimeout(function () {
    ...
    s(".dtr-animated-headline.letters")
        .find("b")
        .each(function () {
            var e = s(this),
                a = e.text().split(""),
    ...
    (e.fn.attr2 = function () {
        ...
        (e.fn.ajaxSubmit = function (a) {
            ...
            "function" == typeof a
                ? (a = { success: a })
                : void 0 === a && (a = {}),
                (n = a.type || this.attr2("method")),
                (s =
                    (s =
                        "string" == typeof (o = a.url || this.attr2("action"))
                            ? e.trim(o)
                            : "") ||
            ...
            var c = {};
            if ((this.trigger("form-pre-serialize", [this, a, c]), c.veto))
                return (
                    i(
            ...
            if (
                (a.data && ((a.extraData = a.data), (f = e.param(a.data, l))),
                a.beforeSubmit && !1 === a.beforeSubmit(p, this, a))
            )
                return (
                    i("ajaxSubmit: submit aborted via beforeSubmit callback"),
                    this
                );
            if ((this.trigger("form-submit-validate", [p, this, a, c]), c.veto))
                return (
                    i(
            ...
            if (
                ((a.success = function (e, t, r) {
                    for (
                        var n = a.context || this, i = 0, o = h.length;
                        i < o;
                        i++
                    )
            ...
            !1 !== a.iframe && (a.iframe || S)
                ...
                : (w =
                      (b || T) && j
                          ...
                          : e.ajax(a)),
                u.removeData("jqxhr").data("jqxhr", w);
            ...
            function k(t) {
                ...
                if (
                    (((c = e.extend(!0, {}, e.ajaxSettings, a)).context =
                        c.context || c),
                    (f = "jqFormIO" + new Date().getTime()),
                    c.iframeTarget
                        ? (g = (p = e(c.iframeTarget)).attr2("name"))
                            ? (f = g)
                            : p.attr2("name", f)
                        : (p = e(
                              '<iframe name="' +
                    ...
                    (h = {
                        ...
                        abort: function (t) {
                            ...
                            p.attr("src", c.iframeSrc),
                                (h.error = r),
                                c.error && c.error.call(c.context, h, r, t),
                                l && e.event.trigger("ajaxError", [h, c, r]),
                                c.complete && c.complete.call(c.context, h, r);
                        },
                    }),
                    (l = c.global) &&
                        0 == e.active++ &&
                        e.event.trigger("ajaxStart"),
                    l && e.event.trigger("ajaxSend", [h, c]),
                    c.beforeSend && !1 === c.beforeSend.call(c.context, h, c))
                )
                    return c.global && e.active--, T.reject(), T;
                if (h.aborted) return T.reject(), T;
                (v = y.clk) &&
                    (g = v.name) &&
                    !v.disabled &&
                    ((c.extraData = c.extraData || {}),
                    (c.extraData[g] = v.value),
                    "image" == v.type &&
                        ((c.extraData[g + ".x"] = y.clk_x),
                ...
                function A() {
                    ...
                    y.setAttribute("target", f),
                        ...
                        r != c.url && y.setAttribute("action", c.url),
                    ...
                    try {
                        if (c.extraData)
                            for (var s in c.extraData)
                                c.extraData.hasOwnProperty(s) &&
                                    (e.isPlainObject(c.extraData[s]) &&
                                    c.extraData[s].hasOwnProperty("name") &&
                                    c.extraData[s].hasOwnProperty("value")
                                        ? o.push(
                                              e(
                        ...
                        c.iframeTarget || p.appendTo("body"),
                            d.attachEvent
                                ? d.attachEvent("onload", O)
                                : d.addEventListener("load", O, !1),
                ...
                k &&
                    D &&
                    ((c.extraData = c.extraData || {}), (c.extraData[k] = D)),
                ...
                function O(t) {
                    if (!h.aborted && !M) {
                        if (
                            ((E = S(d)) ||
                                (i("cannot access response document"), (t = w)),
                            t === j && h)
                        )
                            return (
                                h.abort("timeout"), void T.reject(h, "timeout")
                            );
                        if (t == w && h)
                            return (
                        ...
                        if ((E && E.location.href != c.iframeSrc) || x) {
                            d.detachEvent
                                ? d.detachEvent("onload", O)
                                : d.removeEventListener("load", O, !1);
                            var r,
                                a = "success";
                            try {
                                if (x) throw "timeout";
                                ...
                                (h.responseText = o ? o.innerHTML : null),
                                    (h.responseXML = E.XMLDocument
                                        ? E.XMLDocument
                                        : E),
                                    n && (c.dataType = "xml"),
                                    (h.getResponseHeader = function (e) {
                                        return { "content-type": c.dataType }[
                                            e.toLowerCase()
                                        ];
                                    }),
                                    o &&
                                        ((h.status =
                                            Number(o.getAttribute("status")) ||
                                            h.status),
                                        (h.statusText =
                            ...
                            h.aborted && (i("upload aborted"), (a = null)),
                                ...
                                l && e.event.trigger("ajaxComplete", [h, c]),
                                l && !--e.active && e.event.trigger("ajaxStop"),
                                c.complete && c.complete.call(c.context, h, a),
                                (M = !0),
                ...
                if ((u = (l = h[o]).name) && !l.disabled)
                    if (r && p.clk && "image" == l.type)
                        ...
                        for (a && a.push(l), s = 0, m = c.length; s < m; s++)
                            n.push({ name: u, value: c[s] });
                    else if (t.fileapi && "file" == l.type) {
                        a && a.push(l);
                        var v = l.files;
                        if (v.length)
                            for (s = 0; s < v.length; s++)
                                n.push({ name: u, value: v[s], type: l.type });
                        else n.push({ name: u, value: "", type: l.type });
                    } else
                        null != c &&
                            (a && a.push(l),
                            n.push({
            ...
            return (
                this.each(function () {
                    ...
                    if (a) {
                        ...
                        else null != n && r.push({ name: this.name, value: n });
                    }
                }),
                e.param(r)
            );
...
!(function (factory) {
    ...
    var cX,
        ...
        compare = function (ev, $el, s, cfg) {
            if (
                Math.sqrt(
                    (s.pX - cX) * (s.pX - cX) + (s.pY - cY) * (s.pY - cY)
                ) < cfg.sensitivity
            )
                return (
    ...
    var c = (function () {
        var c = {
            ...
            d = (function () {
                ...
                return (
                    b && a("html").css("cursor", "pointer").on("click", a.noop),
                    b
                );
            })(),
            e = (function () {
        ...
        return {
            ...
            show: function () {
                ...
                return a.onBeforeShow.call(c) === !1
                    ...
                    : (c
                          .stop(!0, !0)
                          .animate(a.animation, a.speed, function () {
                              a.onShow.call(c);
                          }),
                      this);
            },
...
!(function (e, t, n) {
    ...
    (m.prototype.init = function () {
        var n,
            ...
            h = this.settings;
        if (
            (h.duplicate ? (i.mobileNav = m.clone()) : (i.mobileNav = m),
            h.removeIds &&
        ...
        (i.btn = e(
            [
                "<" +
                    ...
                    s +
                    '_collapsed">',
                '<span class="' + s + '_menutxt">' + h.label + "</span>",
                '<span class="' + n + '">',
            ...
            "" !== h.appendTo
                ? e(h.appendTo).append(a)
                : e(h.prependTo).prepend(a),
        ...
        e(f).each(function () {
            ...
            if (
                ...
                if (h.allowParentLinks && !h.nestedParentLinks && i)
                    e(o)
                        .wrapAll(
                            '<span class="' +
                                s +
                    ...
                    case o:
                        ...
                        var n =
                            (l = (a = e(t.target)
                                ...
                                .parent()
                                .children()
                                .children('[role="menuitem"]:visible')).index(
                                t.target
                            )) + 1;
        ...
        (m.prototype._menuToggle = function (e) {
            var t = this.btn,
                n = this.mobileNav;
            t.hasClass(s + "_collapsed")
                ? (t.removeClass(s + "_collapsed"), t.addClass(s + "_open"))
                : (t.removeClass(s + "_open"), t.addClass(s + "_collapsed")),
        ...
        (m.prototype._itemClick = function (e) {
            var t = this.settings,
                n = e.data("menu");
            n ||
                (((n = {}).arrow = e.children("." + s + "_arrow")),
                (n.ul = e.next("ul")),
                (n.parent = e.parent()),
                n.parent.hasClass(s + "_parent-link") &&
                    ((n.parent = e.parent().parent()),
                    (n.ul = e.parent().next("ul"))),
                e.data("menu", n)),
                n.parent.hasClass(s + "_collapsed")
                    ? (n.arrow.html(t.openedSymbol),
                      n.parent.removeClass(s + "_collapsed"),
                      n.parent.addClass(s + "_open"),
                      n.parent.addClass(s + "_animating"),
                      this._visibilityToggle(n.ul, n.parent, !0, e))
                    : (n.arrow.html(t.closedSymbol),
                      n.parent.addClass(s + "_collapsed"),
                      n.parent.removeClass(s + "_open"),
                      n.parent.addClass(s + "_animating"),
                      this._visibilityToggle(n.ul, n.parent, !0, e));
        }),
        (m.prototype._visibilityToggle = function (t, n, a, i, o) {
            ...
            a && (p = r.duration),
                t.hasClass(s + "_hidden")
                    ? (t.removeClass(s + "_hidden"),
                      o || r.beforeOpen(i),
                      "jquery" === r.animations
                          ? t
                                .stop(!0, !0)
                                .slideDown(p, r.easingOpen, function () {
                                    d(i, n);
                                })
            ...
            return void 0 === t || "object" == typeof t
                ? this.each(function () {
                      e.data(this, "plugin_" + i) ||
                          e.data(this, "plugin_" + i, new m(this, t));
                  })
                ...
                ? (this.each(function () {
                      ...
                      s instanceof m &&
                          "function" == typeof s[t] &&
                          (n = s[t].apply(s, Array.prototype.slice.call(a, 1)));
                  }),
                  void 0 !== n ? n : this)
                : void 0;
        });
        ...
        venobox: function ($) {
            ...
            return (
                ...
                this.each(function () {
                    ...
                    function oe() {
                        d.html(
                            '<div class="vbox-inline">' + e(l).html() + "</div>"
                        ),
                            de();
                    }
                    function te() {
    ...
    function (w) {
        ...
        var L = {
            ...
            x = function (e) {
                return e
                    ? ((t = e),
                      parseInt(w.getComputedStyle(t).height, 10) + e.offsetTop)
                    : 0;
                var t;
            },
            Q = function (e, t, n, o) {
...
!(function (e) {
    function o(o, t) {
        var a =
            t.offset + (o.offset().top - e(window).scrollTop()) * (1 - t.speed);
        o.data("pos_y", a),
