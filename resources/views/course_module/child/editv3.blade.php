                    ...
                    material.innerHTML = `
                        ...
                        <div class="col-md-10">
                            ...
                            @foreach ($quiz as $item)
                                <option value="{{ env('APP_URL_FRONTEND') . '/lms/survey/' . $item->id }}" @if ($item->id == $idQuiz) selected @endif>
                                    {{ $item->name }}
                                </option>
                            @endforeach
                            </select>
                    ...
                    material.innerHTML = `
                        ...
                        <div class="col-md-10">
                            ...
                            @foreach ($eval as $item)
                                <option value="{{ env('APP_URL_FRONTEND') . '/lms/survey/' . $item->id }}" @if ($item->id == $idEval) selected @endif>
                                    {{ $item->name }}
                                </option>
                            @endforeach
                            </select>
