...
@section('content')
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">Class Module: {{ $course_detail->name }} Batch {{ $batch_number }}</h4>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{ route('getCourseClassChildModule', ['id' => $item->id]) }}"
                                            class="btn btn-outline-primary rounded">Content</a>
                                        {{-- </div> --}}
                                    </td>
                                </tr>
                            @endforeach
    ...
    <div id="floating-whatsapp-button">
        <a href="{{ route('getAddCourseClassModule', ['id' => $course_class_id]) }}" target="_blank" data-toggle="tooltip" title="Add Class Module">
