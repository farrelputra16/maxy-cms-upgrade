...
(function (e) {
    ...
    (function () {
        ...
        function q(e, a, t) {
            return [
                parseFloat(e[0]) * (c.test(e[0]) ? a / 100 : 1),
                parseFloat(e[1]) * (c.test(e[1]) ? t / 100 : 1),
            ];
        }
        function C(e, a) {
        ...
        j.pos = {
            ...
            getScrollInfo: function (e) {
                var a =
                    ...
                    s =
                        a === "scroll" ||
                        (a === "auto" && e.width < e.element[0].scrollWidth),
                    r =
                        t === "scroll" ||
                        (t === "auto" && e.height < e.element[0].scrollHeight);
                return {
                    ...
                    e = function (e) {
                        var a = u.left - o.left,
                            ...
                            i = {
                                ...
                                horizontal:
                                    t < 0 ? "left" : a > 0 ? "right" : "center",
                                vertical:
                                    r < 0 ? "top" : s > 0 ? "bottom" : "middle",
                            };
                        if (p < l && x(a + t) < p) {
                            i.horizontal = "center";
                        }
            ...
            flip: {
                left: function (e, a) {
                    ...
                    if (l < 0) {
                        ...
                        p =
                            e.left -
                            a.collisionPosition.marginLeft +
                            o +
                            n +
                            h -
                            i;
...
(function (e) {
    ...
    var t = function (e, a) {
        ...
        this.options.templates = c.extend(
            {},
            t.defaultOptions.templates,
            this.options.templates
        );
        this.options.originalPlacement = this.options.placement;
        this.container = f.isElement(this.options.container)
    ...
    t.prototype = {
        ...
        _createPopover: function () {
            ...
            if (
                ...
                !f.isEmpty(this.options.templates.footer)
            ) {
        ...
        _createIconpicker: function () {
            ...
            for (var r in this.options.icons) {
                if (typeof this.options.icons[r].title === "string") {
                    var i = a.clone();
                    i.find("i").addClass(
                        this.options.fullClassFormatter(
                            this.options.icons[r].title
                        )
                    );
                    i.data("iconpickerValue", this.options.icons[r].title).on(
                        "click.iconpicker",
                        e
                    );
                    ...
                    if (this.options.icons[r].searchTerms.length > 0) {
                        ...
                        for (
                            var l = 0;
                            l < this.options.icons[r].searchTerms.length;
                            l++
                        ) {
        ...
        _isEventInsideIconpicker: function (e) {
            var a = c(e.target);
            if (
                (!a.hasClass("iconpicker-element") ||
                    (a.hasClass("iconpicker-element") &&
                        !a.is(this.element))) &&
                a.parents(".iconpicker-popover").length === 0
            ) {
                return false;
            }
            return true;
                ...
                this.input.on("keyup.iconpicker", function (e) {
                    if (
                        !f.inArray(
                            e.keyCode,
                            [
                                38, 40, 37, 39, 16, 17, 18, 9, 8, 91, 93, 20,
                                46, 186, 190, 46, 78, 188, 44, 86,
                            ]
                        )
                    ) {
                        a.update();
                    } else {
                        a._updateFormGroupStatus(
                            a.getValid(this.value) !== false
                        );
                    }
        ...
        _bindWindowEvents: function () {
            ...
            c(window).on(
                "resize.iconpicker" + t + " orientationchange.iconpicker" + t,
                function (e) {
        ...
        updatePlacement: function (e, a) {
            ...
            var t = {
                ...
                my: "right top",
                of:
                    this.hasInput() && !this.isInputGroup()
                        ? this.input
                        : this.container,
            ...
            if (t !== false) {
                this.popover
                    ...
                    .css(
                        "maxWidth",
                        c(window).width() - this.container.offset().left - 5
                    );
            } else {
                this.popover.css({
                    top: "auto",
        ...
        _updateComponents: function () {
            this.iconpicker
                ...
                .removeClass(
                    "iconpicker-selected " + this.options.selectedCustomClass
                );
        ...
        hasSeparatedSearchInput: function () {
            return (
                this.options.templates.search !== false && !this.isInputSearch()
            );
        },
        ...
        filter: function (r) {
            if (f.isEmpty(r)) {
                ...
                this.iconpicker.find(".iconpicker-item").each(function () {
                    ...
                    var t = e.attr("data-search-terms")
                        ? e.attr("data-search-terms").toLowerCase()
                        : "";
                    a = a + " " + t;
                    var s = false;
                    try {
        ...
        show: function () {
            ...
            c.iconpicker.batch(
                c(".iconpicker-popover.in:not(.inline)").not(this.popover),
                "hide"
            );
