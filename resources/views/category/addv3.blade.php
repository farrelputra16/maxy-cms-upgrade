                ...
                <div class="card-body">
                    ...
                    <form id="addCategory" action="{{ route('postAddCategory') }}" method="post"
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-10">
                                <textarea id="content" class="form-control" name="description" placeholder="Contoh: Program Studi Akuntansi mencakup materi seperti laporan keuangan, perpajakan, dan audit.">{{ old('description') }}</textarea>
