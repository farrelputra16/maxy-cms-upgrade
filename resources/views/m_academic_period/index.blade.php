...
<body>
    <div class="container conTitle">
        <h2 class="h2">Academic Period</h2>
        ...
        <div class="container">
            <div class="row">
                <div class="col-10">
                    ...
                    <span class="divider">></span>
                    <div class="sectionEvent">Academic Period</div>
                </div>
                <div class="col-2">
                    <a class="btnAdd" href="{{ route('getAddAcademicPeriod', ['access' => 'm_Event_type_create']) }}" role="button">Add Academic Period +</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        <div class="row">
            <div class="card">
                <div class="card-body">
                    <table id="table" class="tableAcademicPeriod table-striped custom-striped" style="width:100%">
                        <thead>
                            <tr>
                                <th>ID</th>
                                <th>Name</th>
                        ...
                        <tbody>
                            @foreach ($MAcademicPeriod as $item)
                            <tr>
                                <td>{{ $item->id }}</td>
                                <td>{{ $item->name }}</td>
                                ...
                                <td>
                                    <div class="btn-group">
                                        <a href="{{ route('getEditAcademicPeriod', ['id' => $item->id, 'access' => 'm_Event_type_update']) }}" class="btnEdit">Edit</a>
                                    </div>
                                </td>
                            </tr>
                            @endforeach
...
<script>
    $(document).ready(function() {
        ...
        buttonContainer.insertBefore('.tableAcademicPeriod_wrapper .dataTables_length');
