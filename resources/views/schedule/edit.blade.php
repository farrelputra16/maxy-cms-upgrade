        ...
        <form class="ui form" action="{{ route('postEditCarousel', ['id' => request()->query('id')]) }}" method="post" enctype="multipart/form-data">
            ...
            <div class="field">
                ...
                <div class="field">
                    ...
                    <input type="text" name="short_desc" value="{{ $schedule->short_desc }}">
                ...
                <div class="field">
                    ...
                    <input type="date" id="date" name="date" value="{{ $schedule->date }}">
                    @if ($errors->has('date'))
                ...
                <div class="field">
                    ...
                    <img src="{{ asset('uploads/schedule/about-us/'.$schedule->image) }}" width="100px" height="auto" alt="image"/>
                ...
                <div class="field">
                    ...
                    <textarea name="description" id="description">{{ $schedule->description }}</textarea>
                </div>
                <div class="field">
                    <div class="ui checkbox">
                        <input class="form-check-input" type="checkbox" value="1"
                            {{ $schedule->status == 1 ? 'checked' : '' }} name="status">
                        <label>Aktif</label>
                    </div>
                </div>
            </div>
