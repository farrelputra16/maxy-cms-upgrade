        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <h4 class="card-title">Edit User: {{ $data->name }}</h4>
                    ...
                    <form method="post" enctype="multipart/form-data">
                        ...
                        <div class="mb-3 row">
                            <label for="input-name" class="col-md-2 col-form-label">Slug</label>
                            <div class="col-md-10">
                        ...
                        <div class="mb-3 row">
                            <label for="input-favicon" class="col-md-2 col-form-label">Favicon</label>
                            <div class="col-md-10">
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-10">
                                <select class="form-control select2" name="access_group" data-placeholder="Choose ...">
                                    ...
                                    <option selected value="{{ $data->access_group_id }}">
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-10">
                                <input class="form-control" type="password" name="password" value="{{ $data->paswword }}"
                                    id="password">
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-10">
                                <input class="form-control" type="text" name="referal"
                                    placeholder="Masukkan Kode Referral" value="{{ $data->referal }}" id="referal">
                            </div>
                        </div>
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-10">
                                <input class="form-control" type="date" name="birth"
                                    placeholder="Masukkan Kode Referral" value="{{ $data->date_of_birth }}"
                                    id="birth">
                                @if ($errors->has('birth'))
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-10">
                                <input class="form-control" type="text" name="supervisor_name"
                                    placeholder="Masukkan Nama Dosen Pembimbing" value="{{ $data->supervisor_name }}"
                                    id="supervisor_name">
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-10">
                                <input class="form-control" type="text" name="supervisor_email"
                                    placeholder="Masukkan Nama Dosen Pembimbing" value="{{ $data->supervisor_email }}"
                                    id="supervisor_email">
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-10">
                                <input class="form-control" type="text" name="university"
                                    placeholder="Masukkan Nama Dosen Pembimbing" value="{{ $data->university }}"
                                    id="university">
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-10">
                                <input class="form-control" type="number" name="semester"
                                    placeholder="Masukkan Semester" value="{{ $data->semester }}" id="semester">
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-10">
                                <input class="form-control" type="number" name="postal_code"
                                    placeholder="Masukkan Semester" value="{{ $data->postal_code }}" id="postal_code">
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-10">
                                <input class="form-control" type="text" name="linkedin" id="linkedin"
                                    placeholder="Masukkan LinkedIn" value="{{ $data->linked_in }}">
                            </div>
                        </div>
                        <div class="mb-3 row">
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-10">
                                <textarea id="elm1" name="description" rows="5">{{ $data->description }}</textarea>
                            </div>
                        </div>
