...
<div style="padding: 0px 12px 0px 12px;">
    ...
    <nav class="navbar bg-body-tertiary" style="padding: 12px 0px 12px 0px;">
        <div class="navbar-nav">
            <a class="btn btn-primary" href="{{ route('getAddCourseClassMember', ['access' => 'course_class_member_create']) }}" role="button">Tambah Course Class Member +</a>
        </div>
    </nav>
            ...
            <tbody>
                @foreach ($courseClassMembers as $item)
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('getEditCourseClassMember', ['id' => $item->id, 'access' => 'course_class_member_update']) }}" style="text-decoration: none; color:blue;">Edit</a>
                        </td>
                    </tr>
                @endforeach
            </tbody>
