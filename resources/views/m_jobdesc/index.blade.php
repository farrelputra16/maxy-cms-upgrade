...
@section('content')
    <div style="padding: 0px 12px 0px 12px;">
        ...
        <body>
            ...
            <div class="active section">Partnerships</div>
        </div>
            <div id="example_wrapper">
                <div class="navbar bg-body-tertiary" style="padding: 12px 0px 12px 0px;">
                    <div class="navbar-nav">
                        <a class="btn btn-primary" href="{{ route('getAddPartnership') }}" role="button">Tambah Partnership
                            +</a>
                    </div>
                </div>
                    ...
                    <tbody>
                        @foreach ($partnerships as $item)
                            <tr>
                                ...
                                <td>{{ $item->MPartnershipType->name }}</td>
                                <td>
                                    <img src="{{ asset('uploads/partnership/' . $item->file) }}" alt="Image" style="max-width: 200px; max-height: 150px;">
                                </td>
