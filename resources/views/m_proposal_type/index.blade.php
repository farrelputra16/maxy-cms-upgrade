...
<body>
        ...
        <div class="container">
            <div class="row">
                <div class="col-10">
                    ...
                    <span class="divider">></span>
                    <div class="sectionProposal">Proposal Type</div>
                </div>
                <div class="col-2">
                    <a class="btnAdd" href="{{ route('getAddProposalType', ['access' => 'm_Proposal_type_create']) }}" role="button">Add Proposal Type +</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        <div class="row">
            <div class="card">
                <div class="card-body">
                    <table id="table" class="tableProposalType table-striped custom-striped" style="width:100%">
                        <thead>
                            <tr>
                                <th>ID</th>
                                <th>Name</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="btn-group">
                                        <a href="{{ route('getEditProposalType', ['id' => $item->id, 'access' => 'm_proposal_type_update']) }}" class="btnEdit">Edit</a>
                                    </div>
                                </td>
                            </tr>
                            @endforeach
...
<script>
    $(document).ready(function() {
        ...
        buttonContainer.insertBefore('.tableProposalType_wrapper .dataTables_length');
