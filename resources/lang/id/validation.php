...
return [
    ...
    */
    ...
    'custom' => [
        ...
        'mentor.*' => [
            'required' => 'Kolom dosen wajib diisi.',
        ],
        'jobdesc.*' => [
            'required' => 'Kolom deskripsi pekerjaan wajib diisi.',
        ],
    ],
    ...
    */
    ...
    'attributes' => [
        ...
        'priority' => 'Prioritas',
        'type' => 'Tipe',
        'course_package_id' => 'ID paket kursus',
        'fake' => 'Harga fiktif',
        'price' => 'Harga',
        'course_code' => 'Kode kursus',
        ...
        'role' => 'Peran',
        'user_id' => 'ID pengguna',
        'course_class_id' => 'ID kelas kursus',
        'content' => 'Konten',
        'amount' => 'Jumlah',
        'm_bank_account_id' => 'ID rekening bank',
        'access_group' => 'Grup akses',
