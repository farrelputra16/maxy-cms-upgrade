            ...
            <div class="field">
                    ...
                    <div class="field">
                        ...
                        <select class="form-control" name="course_class_id" id="" required>
                            ...
                            <option value="{{ $currentData->course_class_id }}" selected>
                                {{ $currentData->course_class_batch }}</option>
                ...
                <div class="five fields">
                    ...
                    <div class="field">
                        ...
                        ?>
                        <input type="text" name="total" id="total" placeholder="Rp. {{ $formattedTotal }}"
                            value="{{ $formattedTotal }}" required>
                        @if ($errors->has('total'))
                            @foreach ($errors->get('total') as $error)
                                <span style="color: red;">{{ $error }}</span>
                            @endforeach
                    ...
                    <div class="field">
                        ...
                        ?>
                        <input type="text" name="total_after_discount" id="afterDisc"
                            value="Rp {{ $formattedAfterDiscount }}">
                        @if ($errors->has('total_after_discount'))
                            @foreach ($errors->get('total_after_discount') as $error)
                                <span style="color: red;">{{ $error }}</span>
                            @endforeach
                        ...
                        <select class="form-control" name="m_promo_id" id="">
                            ...
                            @if ($currentData->m_promo_id)
                                <option value="{{ $currentData->m_promo_id }}" selected>
                                    {{ $currentData->promotion_name }}</option>
                            @else
