...
<body>
    ...
    <div class="container">
        <form class="ui form" action="{{ route('postEditSurvey', ['id' => request()->query('id')]) }}" method="post" enctype="multipart/form-data">
            @csrf
            <div class="field">
            ...
            <div class="field">
                ...
                <input type="datetime-local" id="expired_date" name="expired_date" value="{{ $currentData->expired_date }}">
            ...
            <div class="field">
                ...
                <select name="type" class="ui dropdown">
                    <option value="0" @if ($currentData->type==0) selected @endif> Evaluasi </option>
