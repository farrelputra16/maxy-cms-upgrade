...
<html lang="en">
    ...
    <head>
        ...
        <meta charset="utf-8" />
        <title>TUI Calendar | Skote - Admin & Dashboard Template</title>
        ...
        <link href="{{ asset('assets/cms-v3/libs/tui-calendar/tui-calendar.min.css') }}" rel="stylesheet" type="text/css" />

        <!-- Bootstrap Css -->
        <link href="{{ asset('assets/cms-v3/css/bootstrap.min.css') }}" id="bootstrap-style" rel="stylesheet" type="text/css" />
        <!-- Icons Css -->
