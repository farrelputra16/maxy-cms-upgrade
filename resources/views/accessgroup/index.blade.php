...
<body>
        ...
        <div class="container">
            <div class="row">
                <div class="col-10">
                    ...
                    <div class="sectionMaster">Users & Access</div>
                    <span class="divider">></span>
    ...
    <div class="container">
        <div class="row">
            <div class="card">
                <div class="card-body">
                    <table id="table" class="tableGroup table-striped custom-striped w-100">
                        <thead>
                            <tr>
                                <th>ID</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="btn-group">
                                        <a href="{{ route('getEditAccessGroup', ['id' => $item->id]) }}" class="btnEdit">Edit</a>
                                    </div>
                                </td>
                            </tr>
                            @endforeach
