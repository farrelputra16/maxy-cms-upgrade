...
@section('title', 'Add Proposal Status')
...
<head>
    ...
    <title>Add Proposal Status</title>
...
<body>
    <div class="container conTitle">
        <h2 class="h2">Add Proposal Status</h2>
        ...
        <form class="ui form" action="" method="post">
            ...
            <div class="field">
                <div class="field">
                    ...
                    <input type="text" name="name" placeholder="Masukkan Nama Proposal Status">
                    @if ($errors->has('name'))
