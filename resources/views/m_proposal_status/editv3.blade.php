                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('postEditProposalStatus', ['id' => request()->query('id')]) }}" method="post"
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-10">
                                <textarea id="content" class="form-control" name="description" placeholder="Masukkan Deskripsi Status Proposal">{{ old('description', $currentData->description) }}</textarea>
