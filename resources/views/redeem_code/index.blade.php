...
<body>
    ...
    <div class="container">
        <div class="row">
            <div class="col">
                <a class="btnTambahCourse" href="{{ route('getAddRedeemCode') }}" role="button">Tambah Redeem Code</a>
            </div>

            <table id="table" class="tableRedeem table-striped" style="width:100%">
                <thead>
                    <tr>
                        <th>ID</th>
                        <th>Code</th>
        ...
        <script>
            $(document).ready(function() {
                ...
                buttonContainer.insertBefore('.tableRedeem_wrapper .dataTables_length');
