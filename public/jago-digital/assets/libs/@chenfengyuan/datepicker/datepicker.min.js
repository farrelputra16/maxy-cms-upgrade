            ...
            show: function () {
                this.built || this.build(),
                    this.shown ||
                        ...
                        this.$picker
                            .removeClass(g)
                            .on(r, k.proxy(this.click, this)),
                        this.showView(this.options.startView),
                        this.inline ||
                            (this.$scrollParent.on(
                                u,
                                k.proxy(this.place, this)
                            ),
                            k(window).on(
                                a,
            ...
            renderYears: function () {
                for (
                    ...
                    var u = new Date(n + d, 1, 1),
                        p = !1;
                    e &&
                        ((p = u.getFullYear() < e.getFullYear()),
                        -5 === d && (l = p)),
                        !p &&
                            i &&
                            ((p = u.getFullYear() > i.getFullYear()),
                            6 === d && (c = p)),
                        !p &&
                            s &&
                            (p = !1 === s.call(this.$element, u, "year"));
                    var f = n + d === h,
            ...
            renderMonths: function () {
                for (
                    ...
                    e &&
                        ...
                        !m &&
                            r &&
                            (m = !1 === r.call(this.$element, y, "month"));
                    var v = h === c && g === d,
                ...
                (e = [
                    {
                        ...
                        value: function () {
                            ...
                            (this.$trigger = k(e.trigger)),
                                ...
                                (this.inline =
                                    e.inline && (e.container || !this.isInput)),
                    ...
                    },
                    {
                        ...
                        value: function () {
                            ...
                            k.isFunction(t.show) && e.on(p, t.show),
                                ...
                                this.isInput &&
                                    e.on(c, k.proxy(this.keyup, this)),
                                this.inline ||
                                    (t.trigger
                                        ? this.$trigger.on(
                                              r,
                                              k.proxy(this.toggle, this)
                                          )
                                        : this.isInput
                    ...
                    },
                    {
                        ...
                        value: function (t) {
                            ...
                            this.isInput
                                ? t.val(e)
                                : (this.inline && !this.options.container) ||
                                  t.text(e);
                        },
                    },
                ]) && s(t.prototype, e),
                ...
                return (
                    this.each(function (t, e) {
                        ...
                        b(r) &&
                            ((s = n[r]),
                            k.isFunction(s) &&
                                ((h = s.apply(n, o)), a && i.removeData(l)));
                    }),
                    x(h) ? this : h
                );
            }),
