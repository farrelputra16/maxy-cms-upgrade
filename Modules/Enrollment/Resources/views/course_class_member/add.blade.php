...
<head>
    ...
    <title>Add Member for Class:</title>
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/twitter-bootstrap/5.3.0/css/bootstrap.min.css">
    <link rel="stylesheet" href="https://cdn.datatables.net/1.13.6/css/dataTables.bootstrap5.min.css">
    <link rel="stylesheet" href="https://cdn.datatables.net/buttons/2.4.2/css/buttons.bootstrap5.min.css">
    <link rel="stylesheet" type="text/css" href="https://cdnjs.cloudflare.com/ajax/libs/semantic-ui/2.4.1/semantic.min.css">
    <script src="https://code.jquery.com/jquery-3.7.0.min.js" integrity="sha384-btZ82u+UkZp2Hd4zDTLzLzbn/7KW8xbDQbl5cpkL6uj5L/2m8cndGmYVRJsF70UtO" crossorigin="anonymous">
    </script>
...
<body>
    ...
    <div class="container">
        <form class="ui form" action="{{ route('postAddCourseClassMember') }}" method="post">
            ...
            <div class="divTambah">
                <button class="btnTambah">Tambah Course Class Module</button>
            </div>
        </form>
        <a href="{{ url()->previous() }}">
            ...
            <form method="post" action="{{ route('course-class-member.import-csv') }}" enctype="multipart/form-data">
                ...
                <div class="card p-5">
                    <div class="row">
                        ...
                        <!-- <div class="divTambah">
                            <button class="btnTambah" type="submit">Tambah Multiple Users</button>
                        </div> -->
                        <div class="col-6" style="text-align:right">
                            <button type="submit" class="btnTambah ui button primary">Tambah Multiple Users</button>
                        </div>
                    </div>
                </div>
            </form>
        ...
        <script src="https://cdnjs.cloudflare.com/ajax/libs/semantic-ui/2.4.1/semantic.min.js" integrity="sha384-oBEahFNqz9AORwL3hFZO9zrZcIEJ0VlX4z/6xLc3pNRdh5iRNXFbpekwB6h5U2Pg" crossorigin="anonymous">
        </script>
