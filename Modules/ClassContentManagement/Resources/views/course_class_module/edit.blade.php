...
@section('content')
    ...
    <div style="padding: 12px 12px 0px 12px;">
        <h2>Edit Module: @if($course_class_module->course_module_type != '') [{{ $course_class_module->course_module_type }}]  @else [Parent Module Day {{ $course_class_module->priority }}] @endif{{ $course_class_module->course_module_name }}</h2>
        <hr>
