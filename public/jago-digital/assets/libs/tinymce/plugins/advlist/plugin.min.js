...
!(function () {
    ...
    const u = (t) => (e) => l(e) && t.test(e.nodeName),
        d = u(/^(OL|UL|DL)$/),
        g = u(/^(TH|TD)$/),
        c = (t) => (i(t) || "default" === t ? "" : t),
        h = (t, e) => (s) =>
            ((t, e) => {
                ...
                return (
                    e({ parents: t.dom.getParents(s), element: s }),
                    t.on("NodeChange", e),
                    () => t.off("NodeChange", e)
                );
            })(t, (r) =>
                    ...
                    s.setActive(
                        ((t, e, s) =>
                            ((t, e, s) => {
                                ...
                                (e) =>
                                    e.nodeName === s &&
                                    ((t, e) => t.dom.isChildOf(e, t.getBody()))(
                                        t,
                                        e
                                    )
                            ))(t, r, e)
                        ...
                        s.setEnabled(
                            !((t, e) => {
                                ...
                                return (
                                    ((t, e) =>
                                        null !== e && !t.dom.isEditable(e))(
                                        t,
                                        s
                                    ) && t.selection.isEditable()
                                );
                            })(t, n) && t.selection.isEditable()
                        );
                })(t, r.parents)
            ),
        m = (t, s, r, n, i, l) => {
            l.length > 1
                ? ((t, s, r, n, i, l) => {
                      t.ui.registry.addSplitButton(s, {
                          tooltip: r,
                          icon: "OL" === i ? "ordered-list" : "unordered-list",
                          presets: "listpreview",
                          columns: 3,
                          fetch: (t) => {
                              t(
                                  o.map(l, (t) => {
                                      const e = "OL" === i ? "num" : "bull",
                                          s =
                                              "disc" === t || "decimal" === t
                                                  ? "default"
                                                  : t,
        ...
        t.hasPlugin("lists")
            ? (((t) => {
                  ...
                  e("advlist_number_styles", {
                      processor: "string[]",
                      default:
                          "default,lower-alpha,lower-greek,lower-roman,upper-alpha,upper-roman".split(
                              ","
                          ),
                  }),
            ...
            : console.error(
                  "Please use the Lists plugin together with the Advanced List plugin."
              );
    });
})();
