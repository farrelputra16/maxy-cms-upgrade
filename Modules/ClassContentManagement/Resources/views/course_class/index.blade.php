    ...
    <body>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-3">
                        ...
                        <a class="btnDupli btn-primary" href="{{ route('getDuplicateCourseClass') }}"
                            role="button">Duplicate Class +</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row">
                <div class="card">
                    <div class="card-body">
                        <table id="table" class="tableClass table-striped custom-striped display nowrap"
                            style="width:100%">
                            <thead>
                                <tr>
