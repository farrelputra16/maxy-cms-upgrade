...
@section('title', 'Edit Proposal Type')
...
<head>
    ...
    <title>Edit Proposal Type</title>
...
<body>
    <div class="container conTitle">
        <h2 class="h2">Edit Proposal Type</h2>
    ...
    <div class="container">
        <form class="ui form" action="{{ route('postEditProposalType', ['id' => request()->query('id')]) }}" method="post" enctype="multipart/form-data">
            @csrf
            <div class="field">
                <div class="field">
