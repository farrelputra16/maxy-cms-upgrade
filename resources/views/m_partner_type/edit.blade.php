...
@section('title', 'Edit Partnership Type')
...
<head>
    ...
    <title>Edit Partnership Type</title>
...
<body>
    <div class="container conTitle">
        <h2 class="h2">Edit Partnership Type</h2>
    ...
    <div class="breadcrumb pt-2 pb-4">
        ...
        <span class="divider">></span>
        <div class="sectionPartnership">Partnership</div>
    </div>

    <div class="container">
        <form class="ui form" action="{{ route('postEditPartnershipType', ['id' => request()->query('id')]) }}" method="post" enctype="multipart/form-data">
            @csrf
            <div class="field">
                <div class="field">
