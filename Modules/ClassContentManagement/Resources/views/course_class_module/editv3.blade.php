        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <h4 class="card-title">{{ $course_class_module->course_module_name }} <small>[ ID:
                    ...
                    <form action="{{ route('postEditCourseClassModule', ['id' => request()->query('id')]) }}" method="post"
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-10">
                                <select class="form-control select2" name="coursemodulesid" data-placeholder="Choose ...">
                        ...
                        <div class="mb-3 row">
                            <label for="input-tag" class="col-md-2 col-form-label">Course Class (Batch) - Course</label>
                            <div class="col-md-10">
