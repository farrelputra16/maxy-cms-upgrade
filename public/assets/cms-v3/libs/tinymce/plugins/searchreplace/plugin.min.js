...
!(function () {
    ...
    const I = (e, t) =>
            e.isBlock(t) || E(e.schema.getVoidElements(), t.nodeName),
            ...
            if (
                ((e, t) =>
                    ...
                    ((e, t) =>
                        ...
                        t.parentNode &&
                        "false" === e.getContentEditableParent(t.parentNode))(
                        e,
                        t
                    ))(e, n)
            )
        ...
        ne = (t, n) => {
            ...
            const r = f.trim(t.selection.getContent({ format: "text" })),
                ...
                y = (e, o) => ({
                    ...
                    onChange: (t, o) => {
                        e && l(!1, t),
                            "findtext" === o.name && n.get().count > 0 && d(t);
                    },
                    onAction: (e, o) => {
                        const r = e.getData();
                        switch (o.name) {
