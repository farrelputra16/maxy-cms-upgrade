                    ...
                    <table id="datatable" class="table table-bordered dt-responsive nowrap w-100">
                        <thead>
                            <tr>
                                <th>No</th>
                                <th>Id</th>
                                <th class="data-medium">ID Member - Member</th>
                                <th class="data-medium">ID Course - Member</th>
                                <th>Role</th>
                            ...
                            @foreach ($testimonials as $key => $item)
                                <tr>
                                    ...
                                    <td class="data-medium" data-toggle="tooltip" data-placement="top"
                                        ...
                                        {!! \Str::limit($item->membername, 30) !!}
                                    </td>
                                    <td class="data-medium" data-toggle="tooltip" data-placement="top"
                                        title="{{ $item->coursebatch }}">
                                        {!! \Str::limit($item->coursebatch, 30) !!}
                                    </td>
                                    <td>{{ $item->role }}</td>
