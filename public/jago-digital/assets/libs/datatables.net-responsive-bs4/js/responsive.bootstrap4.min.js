...
!(function (n) {
    ...
    "function" == typeof define && define.amd
        ...
        ? ((a = require("jquery")),
          (t = function (e, d) {
              d.fn.dataTable || require("datatables.net-bs4")(e, d),
    ...
    "use strict";
    var n = r.fn.dataTable,
        a = n.Responsive.display,
        l = a.modal,
        u = r(
    ...
    return (
        (a.modal = function (i) {
            return function (e, d, n, a) {
                if (r.fn.modal) {
                    if (d) {
                        if (
                            !r.contains(s, u[0]) ||
                            e.index() !== u.data("dtr-row-idx")
                        )
                            return null;
                        u.find("div.modal-body").empty().append(n());
                    } else {
                        var t, o;
                        i &&
                            i.header &&
                            ((o = (t = u.find("div.modal-header"))
                                .find("button")
                                .detach()),
                            t
                                .empty()
