            ...
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                ...
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('getCourseClassModule') }}">Class Module</a></li>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form id="addCourseClassModuleChild" action="{{ route('postAddCourseClassChildModule') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="mb-3 row">
                            <label for="input-tag" class="col-md-2 col-form-label">Module</label>
                            <div class="col-md-10">
                                <select class="form-control select2" name="course_module_id" data-placeholder="Choose ..."
                                    ...
                                    <option value="{{ $item->id }}" {{ old('course_module_id') == $item->id ? 'selected' : '' }}>[{{ $item->type }}] {{ $item->name }}</option>
                                    @endforeach
                                </select>
                        ...
                        <div class="mb-3 row">
                            <label for="input-slug" class="col-md-2 col-form-label">Priority</label>
                            <div class="col-md-10">
