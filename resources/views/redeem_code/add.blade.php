...
<body>
    <div class="container conTitle">
        <h2 class="h2">Add Redeem Code</h2>
    ...
    <div class="breadcrumb pt-2 pb-4">
        ...
        <span class="divider">></span>
        <div class="sectionCourse">Add Redeem Code</div>
    </div>

    <form class="formAdd ui form" action="{{ route('postAddRedeemCode') }}" method="post">
        @csrf
        <div class="field">
