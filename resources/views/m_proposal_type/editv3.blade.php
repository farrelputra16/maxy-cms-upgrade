...
@section('title', 'Edit Jenis Proposal')
            ...
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                ...
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active">Edit Jenis Proposal</li>
                    </ol>
                </div>
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('postEditProposalType', ['id' => request()->query('id')]) }}" method="post"
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-10">
                                <textarea id="elm1" name="description" placeholder="Masukkan Deskripsi Jenis Proposal">{{ old('description', $currentData->description) }}</textarea>
