    ...
    <div style="padding: 0px 12px 0px 12px;">
        ...
        <nav class="navbar bg-body-tertiary" style="padding: 12px 0px 12px 0px;">
            <div class="navbar-nav">
                <a class="btn btn-primary" href="{{ route('getAddCourseClass', ['access' => 'course_class_create']) }}" role="button">Tambah Course Class +</a>
            </div>
        </nav>
            ...
            <table class="ui tablet unstackable table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('getEditCourseClass', ['id' => $item->id, 'access' => 'course_class_update']) }}" style="text-decoration: none; color:blue;">Edit</a>
                        </td>
                    </tr>
                    @endforeach
                </tbody>
